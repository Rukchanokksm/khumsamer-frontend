...
function EditDialog({ repair, open, onClose, onSave }: EditDialogProps) {
    ...
    function set<K extends keyof UpdateCarRepairInput>(
        k: K,
        v: UpdateCarRepairInput[K],
    ) {
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div className="space-y-1">
                            ...
                            <Select
                                ...
                                onValueChange={(v) =>
                                    set("repairType", v as RepairType)
                                }
                            >
                                <SelectTrigger>
                                    <SelectValue />
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                set(
                                    ...
                                    Number(
                                        e.target.value,
                                    ) as unknown as UpdateCarRepairInput["cost"],
                                )
                            }
                            required
                        />
...
const SORT_LABELS: Record<SortOption, string> = {
    date_desc: "วันที่ล่าสุดก่อน",
    date_asc: "วันที่เก่าไปใหม่",
    cost_desc: "ค่าใช้จ่าย มากไปน้อย",
    cost_asc: "ค่าใช้จ่าย น้อยไปมาก",
}

function sortRepairs(repairs: CarRepair[], sort: SortOption): CarRepair[] {
...
export function CarRepairList({
        ...
        return (
            <div className="text-center py-12 text-muted-foreground">
                ...
                <p className="text-sm mt-1">
                    กดปุ่ม &quot;บันทึกการซ่อม&quot; เพื่อเริ่มบันทึก
                </p>
            </div>
        )
    }
    ...
    const sorted = sortRepairs(repairs, sort)
