...
export function CarExpenseForm({ onAdd }: CarExpenseFormProps) {
  ...
  function handleSubmit(e: React.FormEvent) {
    e.preventDefault();
    if (!form.carName || !form.licensePlate || !form.amount || !form.date || !form.description || !form.category) return;
        ...
        <form onSubmit={handleSubmit} className="space-y-4 pt-2">
          ...
          <div className="space-y-1">
            ...
            <Input
              ...
              placeholder="0.00"
              value={form.amount ?? ""}
              onChange={(e) => set("amount", Number(e.target.value) as unknown as CreateCarExpenseInput["amount"])}
              required
            />
          </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1">
                ...
                <Input
                  ...
                  placeholder="0.00"
                  value={form.liters ?? ""}
                  onChange={(e) => set("liters", Number(e.target.value) as unknown as CreateCarExpenseInput["liters"])}
                />
              </div>
              <div className="space-y-1">
                ...
                <Input
                  ...
                  onChange={(e) => set("pricePerLiter", Number(e.target.value) as unknown as CreateCarExpenseInput["pricePerLiter"])}
                />
              </div>
            </div>
          )}
...
export function TravelExpenseForm({ onAdd }: TravelExpenseFormProps) {
  ...
  function handleSubmit(e: React.FormEvent) {
    e.preventDefault();
    if (!form.tripName || !form.carName || !form.licensePlate || !form.amount || !form.date || !form.description || !form.category) return;
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1">
              ...
              <Input
                ...
                placeholder="0.00"
                value={form.amount ?? ""}
                onChange={(e) => set("amount", Number(e.target.value) as unknown as CreateTravelExpenseInput["amount"])}
                required
              />
            </div>
            <div className="space-y-1">
              ...
              <Input
                ...
                placeholder="0"
                value={form.distance ?? ""}
                onChange={(e) => set("distance", Number(e.target.value) as unknown as CreateTravelExpenseInput["distance"])}
              />
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1">
                ...
                <Input
                  ...
                  placeholder="0.00"
                  value={form.liters ?? ""}
                  onChange={(e) => set("liters", Number(e.target.value) as unknown as CreateTravelExpenseInput["liters"])}
                />
              </div>
              <div className="space-y-1">
                <Label>ราคา/ลิตร (บาท)</Label>
                <Input
                  ...
                  placeholder="0.00"
                  value={form.pricePerLiter ?? ""}
                  onChange={(e) => set("pricePerLiter", Number(e.target.value) as unknown as CreateTravelExpenseInput["pricePerLiter"])}
                />
              </div>
            </div>
          )}
